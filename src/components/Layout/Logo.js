...
function Logo() {
  return (<svg viewBox="90 239.1 539.7 523.9" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
...
export const LogoSvg = () => (
  <svg width="1em" height="1em" fill="currentColor" viewBox="88.8 421.2 473.9 459.9">
    <path d="M291.5,645.5c0-89.7,43.8-167.4,174.2-167.4C465.6,568,406.5,645.5,291.5,645.5"/>
    <path d="M500.3,881.2c24.4,0,43.2-3.5,62.4-10.5c0-71-42.4-121.8-117.2-158.4c-57.2-28.7-127.7-43.6-192.1-43.6
    c28.2-84.6,7.6-189.7-19.7-247.4c-30.3,60.4-49.2,164-20.1,248.3c-57.1,4.2-102.4,29.1-121.6,61.9c-1.4,2.5-4.4,7.8-2.6,8.8
